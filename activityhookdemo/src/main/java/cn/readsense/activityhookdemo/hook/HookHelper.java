package cn.readsense.activityhookdemo.hook;
...
public class HookHelper {
    ...
    public static void hookIActivityTaskManager() {
        try {
            ...
            Object singleton = singletonField.get(null);//获取singletonField属性对应的值
            //拿IActivityManager对象
            Class<?> singletonClass = Class.forName("android.util.Singleton");
            Field mInstanceField = singletonClass.getDeclaredField("mInstance");
            mInstanceField.setAccessible(true);
            //原始的IActivityTaskManager
            final Object IActivityTaskManager = mInstanceField.get(singleton);//获取singleton对象中mInstanceField属性对应的值
